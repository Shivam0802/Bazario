...
const ads = [
    { id: 1, title: "Action shoes", discount: "50%", image: "/shoes.webp", description: "Get the best deals on action shoes" , bgColor:["#93A5CF", "#E4EFE9"]},
    { id: 2, title: "Samsung watches", discount: "30%", image: "/smartwatches.webp", description: "Exclusive discounts on Samsung watches", bgColor:["#FBD786", "#F7797D"]},
    { id: 3, title: "Iphones", discount: "10%", image: "/iphone.webp", description: "Latest iPhones at discounted prices", bgColor : ["#ACACAC","#99F2C8"]},
];
            ...
            <section className="flex flex-col mt-8">
                <div className="flex justify-between items-center mx-28">
                    ...
                    <div className="flex justify-between items-center gap-10 mt-6 w-[60%]">
                        <button id="prev" className="text-gray-900 disabled:opacity-0" onClick={handlePrev} disabled={startIndex === 0}>
                            <ChevronLeft size="20" />
                        </button>
                        <div className="overflow-hidden w-[90%]">
                            <ul id="slider" className="flex jutify-between gap-8 transition-transform duration-500" style={{ transform: `translateX(-${startIndex * 10}%)`, }}>
                        ...
                        <button id="next" className="text-gray-900 disabled:opacity-0" onClick={handleNext} disabled={startIndex + 7 >= items.length}>
