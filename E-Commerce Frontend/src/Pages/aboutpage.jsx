...
const sustainableBlogs = [
    { id: 1, title: "Reduce, Reuse, Recycle : Recycle over 10 million waste in 1 year", image: "/reduce.webp", date: "March 15, 2025" },
    { id: 2, title: "Eco-Friendly Living: Tips for a Greener Home", image: "/ecofriendly.webp", date: "March 10, 2025" },
    { id: 3, title: "Design sustainable packing in e-commerce", image: "/packing.webp", date: "March 5, 2025" },
    { id: 4, title: "Completely eliminate single-use plastic by 2026", image: "/plastic.webp", date: "March 1, 2025" },
    { id: 5, title: "Complete electrification of e-commerce delivery fleet", image: "/delivery.webp", date: "February 25, 2025" },
];
        ...
        <>
            ...
            <section className="flex items-center justify-between m-6 bg-gradient-to-r from-[#F5F7FA] to-[#C3CFE2] rounded-[2.5rem] p-10">
                ...
                <div className="flex flex-col my-5 w-[50%] mx-20">
                    ...
                    <Link to="/blog" className="bg-[#C73659] text-white text-center font-normal text-[1.15rem] uppercase py-3 px-4 rounded-md mt-10 w-[60%]">
